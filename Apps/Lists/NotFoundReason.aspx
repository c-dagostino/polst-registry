<%@ page language="VB" masterpagefile="~/Apps/PolstMaster.master" autoeventwireup="false" inherits="Apps_Lists_NotFoundReason, App_Web_exvb2sii" title="POLST, Manage Reason not Found List" theme="Default" %>
...
<script language="javascript" type="text/javascript">
 ...
 <div style="width: 940px" class="fmHead">POLST Manage Not Found Reasons</div>
...
<div style="padding-top:5px; padding-bottom: 5px;" align="center"><asp:Label ID="lblMessage" runat="server" ForeColor="Red" EnableViewState="false" Visible="false"></asp:Label></div>
	  ...
	  <telerik:RadGrid ID="RadGrid1" Skin="Vista" GridLines="None" runat="server" DataSourceID="ods1"
			...
			<MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="Id" DataSourceID="ods1" OverrideDataSourceControlSorting="true"
				...
				<Columns>
					...
					<telerik:GridTemplateColumn HeaderText="Not Found Reason" SortExpression="Name"
						UniqueName="NameName">
	 ...
	 <asp:ObjectDataSource ID="ods1" runat="server" 
		DataObjectTypeName="Polst.Model.NotFoundReason" InsertMethod="UpsertNotFoundReason" 
		SelectMethod="GetNotFoundReasons" TypeName="Polst.BusinessLogic.NotFoundReasonProvider" 
		UpdateMethod="UpsertNotFoundReason"></asp:ObjectDataSource> 
