<%@ Page Language="C#" MasterPageFile="~/Apps/PolstMaster.master" AutoEventWireup="true" CodeBehind="Facility.aspx.cs" Inherits="PolstWebApp.Apps.Lists.Facility" title="POLST, Manage Facility of Residence List" %>
...
<script language="javascript" type="text/javascript">
 ...
 <div style="width: 940px" class="fmHead">POLST Manage Facility of Residence List</div>
...
<div style="padding-top:5px; padding-bottom: 5px;" align="center"><asp:Label ID="lblMessage" runat="server" ForeColor="Red" EnableViewState="false" Visible="false"></asp:Label></div>
      ...
      <telerik:RadGrid ID="RadGrid1" Skin="Vista" AllowAutomaticDeletes="False" AllowPaging="True" OnItemInserted="RadGrid1_ItemInserted" 
            AllowAutomaticInserts="False" AllowAutomaticUpdates="False" AllowSorting="true" EnableLinqExpressions="false" AllowFilteringByColumn="true" 
                runat="server" Width="900px" OnItemCommand="RadGrid1_ItemCommand" OnUpdateCommand="RadGrid1_UpdateCommand" OnInsertCommand="RadGrid1_InsertCommand"
            GridLines="None" >
            <PagerStyle Mode="NextPrevAndNumeric" />
            <FilterItemStyle HorizontalAlign="Left" />
            <AlternatingItemStyle BackColor="#DCE2F3" />
                        <MasterTableView DataKeyNames="FacilityID" Width="100%" CommandItemDisplay="Top" OverrideDataSourceControlSorting="true"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Facility of Residence" 
                        SortExpression="Name" DataField="Name" AllowFiltering="true" >
                    ...
                    <telerik:GridTemplateColumn HeaderText="Apt" Visible="false"
                        SortExpression="AptNumber" UniqueName="AptNumber" AllowFiltering="false">
                        
                       
                        <EditItemTemplate>
                        <div align="left">
                            <asp:TextBox ID="txtAptNumber" runat="server" MaxLength="25" 
                                Text='<%# Bind("AptNumber")%>' Width="75px"></asp:TextBox>
                        </div>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Zip"  Visible="false"
                    ...
                    <telerik:GridTemplateColumn HeaderText="County"  Visible="false"
