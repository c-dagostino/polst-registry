<%@ page language="VB" masterpagefile="~/Apps/PolstMaster.master" autoeventwireup="false" validaterequest="false" inherits="Apps_Lists_Hospital, App_Web_exvb2sii" title="POLST, Manage Hospital List" theme="Default" %>
...
<script language="javascript" type="text/javascript">
 ...
 <div style="width: 940px" class="fmHead">POLST Manage Hospitals</div>
...
<div style="padding-top:5px; padding-bottom: 5px;" align="center"><asp:Label ID="lblMessage" runat="server" ForeColor="Red" EnableViewState="false" Visible="false"></asp:Label></div>
      ...
      <telerik:RadGrid ID="RadGrid1" Skin="Vista" AllowAutomaticDeletes="False" AllowPaging="True" OnItemInserted="RadGrid1_ItemInserted" 
            ...
            <AlternatingItemStyle BackColor="#DCE2F3" />
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Hospital" SortExpression="Name"  DataField="Name"
                        UniqueName="Name">
                     ...
                     <telerik:GridTemplateColumn HeaderText="Fax" SortExpression="Fax"  DataField="Fax"
                        UniqueName="Fax">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                             <telerik:RadMaskedTextBox ID="txtFaxNumber" Runat="server" style="border-bottom: solid 1px #d2d2d2; border-right: solid 1px #d2d2d2; border-left: solid 1px #d2d2d2; border-top: outset 2px #d2d2d2; font-family: Verdana; font-size: 11px; color: #333333"
                            Mask="(###)-###-####" Text='<%# Bind("Fax")%>' Enabled="false" ></telerik:RadMaskedTextBox>
                        </ItemTemplate>
                        <EditItemTemplate>
                          <div align="left">
                            <telerik:RadMaskedTextBox ID="txtFaxNumber" Runat="server" style="border-bottom: solid 1px #d2d2d2; border-right: solid 1px #d2d2d2; border-left: solid 1px #d2d2d2; border-top: outset 2px #d2d2d2; font-family: Verdana; font-size: 11px; color: #333333"
                            Mask="(###)-###-####" Text='<%# Bind("Fax")%>' ></telerik:RadMaskedTextBox>
                         </div>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Address"  DataField="Address"
    ...
    <asp:ObjectDataSource ID="ods1" runat="server" 
        DataObjectTypeName="Polst.Model.Hospital" InsertMethod="UpsertHospital" 
        SelectMethod="GetHospitals" TypeName="Polst.BusinessLogic.HospitalProvider" 
        UpdateMethod="UpsertHospital"></asp:ObjectDataSource> 
