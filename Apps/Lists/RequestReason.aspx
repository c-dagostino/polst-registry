<%@ page language="VB" masterpagefile="~/Apps/PolstMaster.master" enableeventvalidation="false" autoeventwireup="false" inherits="Apps_Lists_RequestReason, App_Web_exvb2sii" title="POLST, Manage Reason for Request List" theme="Default" %>
...
<script language="javascript" type="text/javascript">
 ...
 <div style="width: 940px" class="fmHead">POLST Manage Call Request Reasons</div>
...
<div style="padding-top:5px; padding-bottom: 5px;" align="center"><asp:Label ID="lblMessage" runat="server" ForeColor="Red" EnableViewState="false" Visible="false"></asp:Label></div>
      ...
      <telerik:RadGrid ID="RadGrid1" Skin="Vista" GridLines="None" runat="server" DataSourceID="ods1"
            AllowAutomaticDeletes="True" AllowAutomaticInserts="True" Width="900px" PageSize="10" AllowSorting="true"
            ...
            <MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="Id" DataSourceID="ods1" OverrideDataSourceControlSorting="true"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Request Reason" SortExpression="Name"
                        UniqueName="NameName">
   ...
   <asp:ObjectDataSource ID="ods1" runat="server" 
        DataObjectTypeName="Polst.Model.CallReason" InsertMethod="UpsertCallReason" 
        SelectMethod="GetCallReasons" TypeName="Polst.BusinessLogic.CallReasonProvider" 
        UpdateMethod="UpsertCallReason"></asp:ObjectDataSource> 
   </asp:Content>
