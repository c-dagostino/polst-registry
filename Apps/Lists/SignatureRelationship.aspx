<%@ page language="VB" masterpagefile="~/Apps/PolstMaster.master" autoeventwireup="false" inherits="Apps_Lists_SignatureRelationship, App_Web_exvb2sii" title="POLST, Manage Signature Relationship List" theme="Default" %>
...
<script language="javascript" type="text/javascript">
 ...
 <div style="width: 940px" class="fmHead">POLST Manage Signature Relationship List</div>
...
<div style="padding-top:5px; padding-bottom: 5px;" align="center"><asp:Label ID="lblMessage" runat="server" ForeColor="Red" EnableViewState="false" Visible="false"></asp:Label></div>
      ...
      <telerik:RadGrid ID="RadGrid1" Skin="Vista" GridLines="None" runat="server" DataSourceID="ods1"
         ...
         AutoGenerateColumns="False">
            ...
            <MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="Id" DataSourceID="ods1" OverrideDataSourceControlSorting="true"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Signature Relationship" 
                        SortExpression="Name" UniqueName="Name">
                        <HeaderStyle Width="700px" />
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                            <asp:Label ID="lblRelation" runat="server" Text='<%# Eval("Name")%>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtRelation" runat="server" MaxLength="150" 
                                Text='<%# Bind("Name")%>' Width="600px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvRelation" runat="server" 
                                ControlToValidate="txtRelation" Display="Dynamic" 
        ...
        DataObjectTypeName="Polst.Model.SignatureRelationship" InsertMethod="UpsertSignatureRelationship" 
        SelectMethod="GetSignatureRelationships" TypeName="Polst.BusinessLogic.SignatureRelationshipProvider" 
        UpdateMethod="UpsertSignatureRelationship"></asp:ObjectDataSource> 
   </asp:Content>
