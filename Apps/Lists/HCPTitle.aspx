<%@ Page Language="C#" MasterPageFile="~/Apps/PolstMaster.master" AutoEventWireup="true" CodeBehind="HCPTitle.aspx.cs" Inherits="PolstWebApp.Apps.Lists.HCPTitle" title="POLST, Manage HCP List" %>
...
<script language="javascript" type="text/javascript">
 ...
 <div style="width: 940px" class="fmHead">POLST Manage HCP Title List</div>
            ...
            <MasterTableView Width="100%" CommandItemDisplay="Top" DataKeyNames="Id" DataSourceID="ods1" OverrideDataSourceControlSorting="true"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="Id" HeaderText="ID" ReadOnly="True" 
                        SortExpression="Id" UniqueName="HCP_TitleID" Visible="False">
                    </telerik:GridBoundColumn>
                    <telerik:GridTemplateColumn HeaderText="HCP Title" 
...
<asp:ObjectDataSource ID="ods1" runat="server" 
        DataObjectTypeName="Polst.Model.HCPTitle" InsertMethod="UpsertHCPTitle" 
        SelectMethod="GetHCPTitles" TypeName="Polst.BusinessLogic.HCPTitleProvider" 
        UpdateMethod="UpsertHCPTitle"></asp:ObjectDataSource> 
</asp:Content>
