<%@ page title="Forms Updated by User" language="VB" masterpagefile="~/Apps/PolstMaster.master" autoeventwireup="false" inherits="Apps_Reports_FormsUpdatedByUser, App_Web_fwiw5g31" theme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div style="width: 940px" class="fmHead">POLST Forms Updated by User</div>
         ...
         <MasterTableView CommandItemDisplay="None" FilterItemStyle-Wrap="false"
            ...
            <CommandItemTemplate>
             ...
             <Columns>
                ...
                <telerik:GridTemplateColumn DataField="UpdateDate" HeaderText="Date Updated" SortExpression="UpdateDate" HeaderStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Top">
                        <ItemTemplate>
                           <%#DateTime.Parse(Eval("UpdateDate")).ToShortDateString%>
                        </ItemTemplate>
                </telerik:GridTemplateColumn>
                
                  <telerik:GridTemplateColumn AllowFiltering="true" SortExpression="RFormStatus" ItemStyle-Wrap="false" HeaderText="Updated Status" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                        <%#IIf(IsDBNull(Eval("RFormStatus")), "n/a", Eval("RFormStatus"))%>
                ...
                <telerik:GridBoundColumn DataField="Updates" HeaderText="Update(s) Made" SortExpression="Updates" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="280px" HeaderStyle-Width="280px" HeaderStyle-HorizontalAlign="Left"></telerik:GridBoundColumn>
                 <telerik:GridTemplateColumn AllowFiltering ="false" ItemStyle-Wrap="false" HeaderStyle-Width="40px" ItemStyle-Width="40px" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
