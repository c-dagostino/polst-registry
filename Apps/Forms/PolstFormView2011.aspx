<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolstFormView2011.aspx.cs" Inherits="PolstWebApp.Apps.Forms.PolstFormView2011"  MasterPageFile="~/Apps/PolstMaster.master" Title="Polst Form" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpScripts" runat="Server">
    <script type="text/javascript" src="../Scripts/PolstFormView2011.js?id=<%= DateTime.Now.ToShortDateString() %>""></script>
            ...
            <tr>
                ...
                <td align="right">
                    <div style="display: inline; padding-right: 15px">
                        <asp:Button ID="btnActivate" Text="Activate Form" runat="server" OnClientClick="return false;" OnClick="btnActivate_Click" CssClass="jqPostbackElement"
                            EnableViewState="false" ClientIDMode="Static" />
                    </div>
                    <div style="display: inline; padding-right: 15px">
                        <asp:Button ID="btnArchive" Text="Archive Form" runat="server" OnClientClick="javascript:return archiveForm()" CssClass="jqPostbackElement"
                            ...
                            <td colspan="2">
                                <table>
                                        ...
                                        <td class="fmFieldText">
                                            <div class="innerFormPanel">
                                                <div style="padding-right: 10px; padding-top: 5px; padding-left: 5px; padding-bottom: 5px;
                                                    display: inline">
                                                    <asp:DropDownList ID="ddlPostForms" AutoPostBack="true" runat="server" Style="font-size: 11px;" OnSelectedIndexChanged="ddlPostForms_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td class="fmFieldText">
                                            <div class="innerFormPanel">
                                                <div id="divCPR" runat="server" ClientIDMode="Static">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        ...
                                        <td class="fmFieldText">
                                            <div class="innerFormPanel">
                                                <div id="divMedIntervention" runat="server" ClientIDMode="Static">
                                                </div>
                                                <div class="aomargins">
                                                    Additional Orders:&nbsp;<asp:Label ID="lblMedInterventionAO" runat="server" CssClass="polstViewTextHeightNormal" ClientIDMode="Static"></asp:Label></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        ...
                                        <td class="fmFieldText">
                                            <div class="innerFormPanel">
                                                <div id="divAAN" runat="server" ClientIDMode="Static">
                                                </div>
                                                <div class="aomargins">
                                                    Additional Orders:&nbsp;<asp:Label ID="lblAANutritionAO" runat="server" CssClass="polstViewTextHeightNormal"  ClientIDMode="Static"></asp:Label></div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        <td class="fmFieldHeader" style="vertical-align: text-top">
                                            Reason for Orders<br />
                                            and Signatures:
                                        </td>
                                        <td class="fmFieldText">
                                            <div class="innerFormPanel">
                                            ...
                                            <div class="innerFormPanel">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td class="fmFieldText">
                                                            <asp:Label ID="lblSigningPhys" runat="server" ClientIDMode="Static"></asp:Label>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fmFieldText" style="vertical-align: middle">
                                                            <asp:Label ID="lblDateSigned" runat="server" ClientIDMode="Static"></asp:Label>
                                                        </td>
                                                        <td colspan="2" class="fmFieldText" style="padding-left: 15px">
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                        ...
                                                        <td class="fmFieldHeader" style="padding-left: 15px" nowrap>
                                                            License Expire Date:
                                                        </td>
                                                        <td class="fmFieldText" style="vertical-align: middle">
